...
import { Search, MapPin, BriefcaseBusiness, ArrowRight } from "lucide-react";
    ...
    const fetchJobs = async () => {
      try {
        ...
        if (response.ok && data.success) {
          ...
          console.error(data.message || "Failed to load jobs");
        }
      } catch (error) {
  ...
  return (
    <div className="jobs-page">
      ...
      <section className="jobs-hero">
        ...
        <p>
          Where talent learns, grows, and connects with opportunities
          at Centennial.
        </p>
      ...
      <main className="jobs-container">
        ...
        {loading ? (
          ...
          <div className="jobs-message">
            ...
            <p>
              There are currently no job opportunities matching
              your search.
            </p>
              ...
              >
                ...
                {job.salaryMin || job.salaryMax ? (
                  <p className="job-salary">
                    ₹ {Number(job.salaryMin || 0).toLocaleString("en-IN")}
                    {" - "}
